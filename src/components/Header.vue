    ...
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
        <div class="relative flex items-center justify-between h-16">
            ...
            <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
                <!-- small logo -->
                <span class="block lg:hidden text-blue-500 text-2xl font-bold mr-2">
                    CR-LOTES
                </span>
            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                <div class="flex-shrink-0">
                    <!-- small logo -->
                    <span class="hidden sm:block lg:hidden h-8 w-auto text-blue-800 text-2xl  font-bold">
                        CR
                    </span>

                    <!-- big logo -->
                    <span  class="hidden lg:block h-8 w-auto text-blue-50 text-2xl font-bold text-gray-200 uppercase">
                        CR-Lotes
                    </span>
                </div>
