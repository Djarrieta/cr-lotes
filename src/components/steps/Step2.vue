    ...
    <div class="flex flex-col p-4">
      ...
      <div class="my-1">
		...
		<div class="flex relative">
			...
			<div></div><!-- div vacío para organizar el tamaño por defecto del contenedor relative -->
			<div class="absolute bottom-0 | m-2 px-1 rounded bg-gray-900 text-gray-500">Ajusta la ubicación arrastrando el pin</div>
		</div>
  </div>
